...
type InventoryOut struct {
	...
	IsDeleted  int8       `json:"is_deleted" db:"is_deleted" gorm:"column:is_deleted;type:tinyint(1);default:0;null;" sqlca:"nullable"`
	DeleteTime *time.Time `json:"delete_time" db:"delete_time" gorm:"column:delete_time;type:datetime;null;" sqlca:"nullable"`
	ProductId  uint64     `json:"product_id" db:"product_id" gorm:"column:product_id;type:bigint unsigned;index:i_product_id,priority:1;uniqueIndex:UNIQ_PROD_USER,priority:1;default:0;null;" sqlca:"nullable"`
	OrderNo    string     `json:"order_no" db:"order_no" gorm:"column:order_no;type:varchar(64);uniqueIndex:UNIQ_ORDER_NO,priority:1;null;" sqlca:"nullable"`
	UserId     uint64     `json:"user_id" db:"user_id" gorm:"column:user_id;type:bigint unsigned;index:i_user_id,priority:1;uniqueIndex:UNIQ_PROD_USER,priority:2;default:0;null;" sqlca:"nullable"`
	UserName   string     `json:"user_name" db:"user_name" gorm:"column:user_name;type:varchar(64);index:FULTXT_user_name,priority:1;null;" sqlca:"nullable"`
	Quantity   float64    `json:"quantity" db:"quantity" gorm:"column:quantity;type:decimal(16,6);default:0.000000;null;" sqlca:"nullable"`
	Weight     float64    `json:"weight" db:"weight" gorm:"column:weight;type:decimal(16,6);default:0.000000;null;" sqlca:"nullable"`
	Remark     string     `json:"remark" db:"remark" gorm:"column:remark;type:varchar(512);null;" sqlca:"nullable"`
	CreateId   uint64     `json:"create_id" db:"create_id" gorm:"column:create_id;type:bigint unsigned;default:0;null;" sqlca:"nullable"`
...
func (do InventoryOut) DatabaseName() string { return "test" }

func (do InventoryOut) TableName() string { return TableNameInventoryOut }
