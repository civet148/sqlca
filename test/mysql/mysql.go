...
func Benchmark() {
	...
	e.Open("mysql://root:123456@127.0.0.1:3306/test?charset=utf8mb4", &sqlca.Options{Max: 20, Idle: 2}) //MySQL main
	e.Open("mysql://root:123456@127.0.0.1:3306/test?charset=utf8mb4&subordinate=true&max=100&idle=5")         //MySQL subordinate
...
func MYSQL_OrmQueryIntoModelSlice(e *sqlca.Engine) {
	...
	if rowsAffected, err := e.Model(&users).Table(TABLE_NAME_USERS).Limit(3).Subordinate().Query(); err != nil {
