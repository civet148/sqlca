...
func Benchmark() {
	...
	/*
		POSTGRES set auto incr id

		1. open query command window, create sequences for table users and classes

			CREATE SEQUENCE user_id_seq START 1;
			CREATE SEQUENCE class_id_seq START 1;

		2. design table users, set 'id' column default value is  nextval('user_id_seq') and save.
		3. design table classes, set 'id' column default value is  nextval('class_id_seq') and save.
	*/
